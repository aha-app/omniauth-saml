      ...
      info do
        {
          ...
          :email => @attributes['EmailAddress'] || @attributes[:email] || @attributes[:mail] || @attributes['User.email'] || @attributes['http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress'] || @attributes['http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name'],
